# Day 7: Week 1 Recap & Coding Challenge:
This folder contains C++ and Python examples demonstrating a **full recap of Week 1 concepts**, including syntax, variables, data types, operators, loops, conditionals, arrays/lists, functions, and advanced function features. Day 7 focuses on **reviewing all concepts learned so far** and applying them in a practical challenge: the **Student Marks Analyzer**.

## Concept

Week 1 covered the foundational building blocks of programming in both C++ and Python.

- **Syntax & Variables (Day 1):** Understanding how to declare variables, assign values, and perform input/output operations.  
- **Operators & Expressions (Day 2):** Using arithmetic, relational, and logical operators to perform calculations and comparisons.  
...
1. Input **5 student names and marks** from the user.  
2. Store the data in an **array (C++) / list (Python)**.  
...
- `cpp_example.cpp`  C++ implementation of Student Marks Analyzer  
- `python_example.py`  Python implementation of Student Marks Analyzer  
